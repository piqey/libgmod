...
--- @return GWeapon @The retrieved table or nil
...
--- @return GWeapon[] @List of all the registered SWEPs
...
--- @return GWeapon @The weapon table
...
--- @param swep_table GWeapon @The SWEP table
